...
<link rel="stylesheet"
	href="<%=request.getContextPath()%>/resources/css/bootstrap/4.5.2/bootstrap.min.css" />
<link rel="stylesheet"
	href="<%=request.getContextPath()%>/resources/css/admin.css" />
<script
	src="<%=request.getContextPath()%>/resources/js/jquery-1.9.1.min.js"></script>
<script
	src="<%=request.getContextPath()%>/resources/js/bootstrap/4.5.2/bootstrap.js"></script>
<script>
...
<nav
	...
	<div class="flex-row d-flex">
		...
		<a class="navbar-brand" href="#"
			title="Free Bootstrap 4 Admin Template">DUZON PAY</a>
	</div>
	...
	<div class="navbar-collapse collapse" id="collapsingNavbar">
		<ul class="navbar-nav">
			...
			<li class="nav-item"><a class="nav-link" href="#">거래관리 <span
					class="sr-only">거래관리</span>
			</a></li>
			<li class="nav-item"><a class="nav-link" href="#">정산/통계관리 <span
					class="sr-only">정산/통계관리</span>
			</a></li>
			<li class="nav-item"><a class="nav-link" href="#">마켓팅/CS관리 <span
					class="sr-only">마켓팅/CS관리</span>
			</a></li>
			<li class="nav-item"><a class="nav-link" href="#">사이트관리 <span
					class="sr-only">사이트관리</span>
			</a></li>
			<li class="nav-item"><a class="nav-link" href="#">모바일관리 <span
					class="sr-only">모바일관리</span>
			</a></li>
			<li class="nav-item"><a class="nav-link" href="#">시스템관리 <span
					class="sr-only">시스템관리</span>
			</a></li>
			<li class="nav-item"><a class="nav-link" href="#">영업관리 <span
					class="sr-only">영업관리</span>
			</a></li>
		</ul>
		<ul class="navbar-nav ml-auto">
			...
			<li class="nav-item"><a class="nav-link" href="#myAlert"
				data-toggle="collapse">공지사항</a></li>

			<spring:authorize access="isAuthenticated()">
				<li class="nav-item"><a class="nav-link"
					href="<%=request.getContextPath()%>/init/proc/logout.do">로그아웃</a></li>
			</spring:authorize>

			<spring:authorize access="hasRole('ROLE_ADMIN')">
				<li class="nav-item"><a class="nav-link"
					href="<%=request.getContextPath()%>/admin/master.do">Sudo</a></li>
			</spring:authorize>
	...
	<div class="row row-offcanvas row-offcanvas-left">
		<div class="col-md-3 col-lg-2 sidebar-offcanvas bg-light pl-0"
			...
			<ul class="nav flex-column sticky-top pl-0 pt-5 mt-3">
				<li class="nav-item"><a class="nav-link" href="#">거래 관리 시스템</a></li>
				<li class="nav-item"><a class="nav-link" href="#submenu1"
					data-toggle="collapse" data-target="#submenu1">카드 결제</a>
					<ul class="list-unstyled flex-column pl-3 collapse" id="submenu1"
						aria-expanded="false">
						<li class="nav-item"><a class="nav-link" href="">온라인 카드결제</a></li>
						<li class="nav-item"><a class="nav-link" href="">모바일 카드결제</a></li>
					</ul></li>
				<li class="nav-item"><a class="nav-link" href="#">EDI 수기 결제</a></li>
				<li class="nav-item"><a class="nav-link" href="#">휴대폰 자료관리</a></li>
				<li class="nav-item"><a class="nav-link" href="#">계좌이체 자료관리</a></li>
				<li class="nav-item"><a class="nav-link" href="#">가상계좌 자료관리</a></li>
				<li class="nav-item"><a class="nav-link" href="#">통합 거래조회</a></li>
				<li class="nav-item"><a class="nav-link" href="#">현금 영수증 관리</a></li>
				<li class="nav-item"><a class="nav-link" href="#submenu1"
					data-toggle="collapse" data-target="#submenu1">위하고 거래 조회</a>
					<ul class="list-unstyled flex-column pl-3 collapse" id="submenu1"
						aria-expanded="false">
						<li class="nav-item"><a class="nav-link" href="">위하고 통합거래
								조회</a></li>
						<li class="nav-item"><a class="nav-link" href="">위하고 통합거래
								취소 조회</a></li>
					</ul></li>
		...
		<div class="col main pt-5 mt-3">
			<h1 class="display-4 d-none d-sm-block">금일 통계 현황</h1>
			<p class="lead d-none d-sm-block">
				**
				<%=today.substring(0, 4)%>년
				<%=today.substring(4, 6)%>월
				<%=today.substring(6, 8)%>일 기준입니다.
			</p>
				...
				<div class="col-xl-3 col-sm-6 py-2">
					<div class="card bg-success text-white h-100">
						<div class="card-body bg-success">
							...
							<h6 class="text-uppercase">신용카드 온라인</h6>
							<h1 class="display-8">134만 9천 600원</h1>
						</div>
					</div>
				</div>
				<div class="col-xl-3 col-sm-6 py-2">
					<div class="card text-white bg-danger h-100">
						<div class="card-body bg-danger">
							...
							<h6 class="text-uppercase">EDI 수기 결제</h6>
							<h1 class="display-8">80만 9천 800원</h1>
						</div>
					</div>
				</div>
				<div class="col-xl-3 col-sm-6 py-2">
					<div class="card text-white bg-info h-100">
						<div class="card-body bg-info">
							...
							<h6 class="text-uppercase">계좌이체</h6>
							<h1 class="display-8">180만 9천 300원</h1>
						</div>
					</div>
				</div>
				<div class="col-xl-3 col-sm-6 py-2">
					<div class="card text-white bg-warning h-100">
						<div class="card-body">
							...
							<h6 class="text-uppercase">가상계좌 (입금완료기준)</h6>
							<h1 class="display-8">2억 3040만 890원</h1>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="col-lg-3 col-md-4">
					...
					<div class="card card-inverse bg-inverse mt-3">
						<div class="card-body">
							...
							<p class="card-text">Flexbox is now the default, and
								Bootstrap 4 supports SASS out of the box.</p>
			...
			<a id="more"></a>
			<hr>
			<h2 class="sub-header mt-5">Use card decks for equal height rows
				of cards</h2>
			<div class="mb-3">
				<div class="card-deck">
					...
					<div class="card card-inverse card-info text-center">
						<div class="card-body">
							<blockquote class="card-blockquote">
								<p>If you want to use cool icons in Bootstrap 4, you'll have
									to find your own such as Font Awesome or Ionicons.</p>
								<footer>
			...
			<div class="card-columns mb-3">
				<div class="card">
					...
					<div class="card-body">
						...
						<p class="card-text">텍스트입니다 텍스트라고요</p>
					</div>
				</div>
			...
			<div class="row mb-3">
				...
				<div class="col-lg-6">
					...
					<ul class="nav nav-tabs" role="tablist">
						<li class="nav-item"><a class="nav-link active" href="#home1"
						...
						<div id="tabsJustifiedContent" class="tab-content">
							...
							<div class="tab-pane active" id="tab2">
								<div class="row">
									...
									<div class="col-sm-5">
										<img src="" class="float-right img-responsive img-rounded">
									</div>
								</div>
								<hr>
				...
				<div class="col-lg-6">
					<div id="accordion" role="tablist" aria-multiselectable="true">
						<div class="card">
							<div class="card-header" role="tab" id="headingOne"
								...
								aria-controls="collapseOne">Accordion example</div>
							...
							<div class="card-header" role="tab" id="headingTwo"
								...
								aria-controls="collapseTwo">Mobile-first</div>
							<div id="collapseTwo" class="card-block collapse" role="tabpanel"
								aria-labelledby="headingTwo">
								<p>Just like it's predecesor, Bootstrap 4 is mobile-first so
					...
					<p class="mt-4">
						<a href="/go/KrUO8QpyXP/bootstrao-4-dashboard" target="_ext">Get
							this Bootstrap 4 admin dashboard at Codeply</a>
					</p>
				</div>
				<!--/col-->
			</div>
...
<footer class="container-fluid bg-light py-2">
	<p class="text-right small mb-0">占쏙옙2016-2020 Company</p>
</footer>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<p>안녕하세요! 고객님 '더존페이' 가맹점 관리자 페이지입니다.
				<p>
					<a href="#" target="_ext">더존페이 관리자 메인</a>
				</p>
			</div>
